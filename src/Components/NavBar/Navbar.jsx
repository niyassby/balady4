...
function Navbar() {
  ...
  return (
    <div
      className={`w-full min-h-[105px] flex justify-between  fixed top-0 left-0 z-50 pb -4 ${isScroll && "shadow-md"
        }`}
    >
      <div style={{ backgroundImage: `linear-gradient(220deg, #000 30.33%, ${isScroll ? "#389492" : "#3894925c"} 83.58%)` }} className="w-full max-lg:hidden relative min-h-[78px] max-h-[600px] overflow-y-auto flex flex-wrap  justify-between mx-auto py-[19px] md:py-2 px-3 transition-all duration-1000 ease-in-out">
        ...
        <div
          className={`w-full z-[1000] lg:flex  lg:items-center relative justify-end mx-3 lg:w-auto ${isToggle ? "block" : "hidden lg:block"
            }`}
        >
          <ul
            dir="rtl"
      ...
      <div style={{ backgroundImage: "linear-gradient(220deg, #000 30.33%, #389492 83.58%)" }} className={`w-full  lg:hidden relative min-h-[99px]  no-scrollbar  flex flex-col  mx-auto py-[19px] md:py-2 px-3 transition-all duration-500 ease-in-out ${openDropdown && isToggle
