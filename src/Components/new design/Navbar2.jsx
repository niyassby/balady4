...
function Navbar2() {
    ...
    return (
        <header dir='rtl' className='top-navbar border-b'>
            <div class="ibm-plex-sans-arabic font-medium mainHeader relative w-full  container-fluid">
                <div class="row">
                    <div class="flex items-center w-full columns px-[15px]">
                        <div class="region region--header">
                            <div id="block-sitebranding"
                                class="clearfix site-branding block block-system block-system-branding-block">
                                <a href="https://balady.gov.sa/ar" rel="home"
                                    class="site-branding__logo"><img className='text-sm text-[#07706d]'
                                        src={logo}
                                        alt="الرئيسية" /></a>
                            </div>
                        </div>
                        <nav
                            class="navbar navbar-expand-lg position-static header-mobile-container">
                            <button onClick={() => setShowNav(!showNav)} class="navbar-toggler md:hidden" type="button">
                            ...
                            <div ref={ref} class={`navbar-collapse flex max-md:flex-col max-md:items-center max-md:justify-center  overflow-hidden transition-all duration-300 ease-in-out ${showNav ? 'max-md:max-h-[1000px]' : 'max-md:max-h-0'}`} id="navbarSupportedContent">
                                <div class="region region--header-content ">
                                    <nav aria-labelledby="block-balady-main-menu-menu"
                                        ...
                                        <div class="block-content">
                                            <ul class="menu flex  w-full  gap-3 " aria-hidden="false">
                                                <li class="menu-item menu-item--expanded  dropdown menu-item-first menu-level-0  menu-count-1 "
                                                    aria-hidden="false">
                                                    <button onClick={() => setShowId(showId == 1 ? null :1)} class=" dropdown-toggle w-full " >
                                                        <span>عن بلدي</span> <ArrowDown01Icon size={16} />
                                                    </button>
                                                    {showId == 1 && <div class="dropdown-menu absolute left-0 w-screen p-5 top-20 ">
                                                ...
                                                <li class="menu-item menu-item--expanded  dropdown menu-item-first menu-level-0  menu-count-2"
                                                    aria-hidden="false">
                                                    <button onClick={() => setShowId(showId == 2 ? null :2)} class=" dropdown-toggle" href="#"
                                                        role="button" data-bs-auto-close="outside"
                                                        aria-expanded="false" aria-hidden="false"
                                                        data-toggle="dropdown">
                                                        <span>الخدمات</span><ArrowDown01Icon size={16} />
                                                    </button>
                                                    {showId == 2 && <div class="dropdown-menu absolute left-0 w-screen p-5 top-20  bg-white">
                                                        <ul class="menu" aria-hidden="false">
                                                            <li class="menu-item menu-item--expanded  menu-level-1 menu-count-1"
                                                                aria-hidden="false">
                                                            ...
                                                            <li class="menu-item menu-level-1 menu-count-5"
                                                                aria-hidden="false">
                                                                <span>صوت العميل</span>
                                                            </li>
                                                            <li class="menu-item menu-level-1 menu-count-6"
                                                                aria-hidden="false">
                                                ...
                                                <li class="menu-item menu-item-first menu-level-0 menu-count-3"
                                                    aria-hidden="false">
                                                    <a href="https://balady.gov.sa/ar/general-inquiries"
                                                        data-drupal-link-system-path="general-inquiries">الاستعلامات</a>
                                                </li>
                                                <li class="menu-item menu-item--expanded  dropdown menu-item-first menu-level-0  menu-count-4"
                                                    aria-hidden="false">
                                                    <button onClick={() => setShowId(showId == 4 ? null :4)} class=" dropdown-toggle" href="#"
                                                        role="button" data-bs-auto-close="outside"
                                                        aria-expanded="false" aria-hidden="false"
                                                        data-toggle="dropdown">
                                                        <span>تواصل معنا</span> <ArrowDown01Icon size={16} />
                                                    </button>
                                                    {showId == 4 && <div class="dropdown-menu absolute left-0 w-screen p-5 top-20  bg-white">
                                                        <ul class="menu" aria-hidden="false">
                                                            <li class="menu-item menu-level-1 menu-count-1"
                                                                aria-hidden="false">
                                                                <a
                                                                    href="https://momah.gov.sa/ar/report-corruption">الإبلاغ
                                                                    عن شبهة فساد</a>
                                                            </li>
                                                            <li class="menu-item menu-level-1 menu-count-2"
                                                                aria-hidden="false">
                                                                <a href="https://balady.gov.sa/ar/form/contact-us"
                                                                    data-drupal-link-system-path="node/22578">اتصل
                                                                    بنا</a>
                                                            </li>
                                                            <li class="menu-item menu-level-1 menu-count-3"
                                                                aria-hidden="false">
                                                            ...
                                                            <li class="menu-item menu-level-1 menu-count-4"
                                                                aria-hidden="false">
                                                            ...
                                                            <li class="menu-item menu-level-1 menu-count-7"
                                                                aria-hidden="false">
                                ...
                                <div class="header-left header-left_hide">
                                    <div class="region-header-left flex items-start">
                                        <a href="https://business.balady.sa/"
                                            class="b-business balady-app btn btn-primary "
                                            aria-label="بلدي أعمال" rel="nofollow noreferrer">بلدي
                                            أعمال
                                            <LinkSquare02Icon size={16} strokeWidth={2} />
                                            </a>

                                        <div class="header-search headersearch_hide">
                                            <a role="button" class="search-link gap-1" id="searchBtn"
                                        ...
                                        <div class="modal fade modal-search hidden" id="headerSearch"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button"
                                                            class="btn-close modal-search-btn-close"
                                                            data-dismiss="modal"
                                                            aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="modal-search-content">
                                                            <div class="search-api-form search">
                                                                ...
                                                                <a href="https://balady.gov.sa/solr-serach-v1"
                                                                    class="btn btn-outline-light btn-adv-search">البحث
                                                                    المتقدم</a>
                                                            </div>
                                                            <div class="modal-search-suggestions">
                                                                <div class="suggestions-content">
                                                                    ...
                                                                    <div class="row g-3">
                                                                        <div class="col-auto">
                                                                            <a class="btn btn-light btn-sug"
                                                                                href="https://balady.gov.sa/products/10920">
                                                                                <i
                                                                                    class="hgi hgi-stroke hgi-plus-sign"></i>
                                                                                الرخص التجارية
                                                                            </a>
                                                                        </div>
                                                                        <div class="col-auto">
                                                                            <a class="btn btn-light btn-sug"
                                                                                ...
                                                                                <i
                                                                                    class="hgi hgi-stroke hgi-plus-sign"></i>الرخص
                                                                                الإنشائية
                                                                            </a>
                                                                        </div>
                                                                        <div class="col-auto">
                                                                            <a class="btn btn-light btn-sug"
                                                                                ...
                                                                                <i
                                                                                    class="hgi hgi-stroke hgi-plus-sign"></i>حجز
